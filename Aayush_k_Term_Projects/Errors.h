...
/// 
/// It contains all of the declaration of the member funciton of Error Class
/// It contains all of the inline funcitons defination of  the member funciton of Errors class 
/// It contains enum class ErrorTypes within the Errors class 
///
/// @author Aayush Karki
///
...
public:
	...
	/// @date  November 12, 2021 
	///
	static inline const std::vector<std::string>::iterator GetErrorMessageBegin() { return m_ErrorMsgs.begin(); }
	...
	/// @date  November 12, 2021 
	///
	static inline const std::vector<std::string>::iterator GetErrorMessageEnd() { return m_ErrorMsgs.end(); }
