...
///
/// It contains all of the declaration of the member funciton of Assembler class.
/// It contains all of the inline funcitons defination of  the member funciton of Assembler class 
/// 
...
public:
	...
	/// @note argc should always be 2 else an error will be raised by the file access class raise an error
	/// 
	...
	///
	/// @brief getter function to check if any error was found in Pass II
	/// 
	/// @return GetNoError returns false if any error was found in PassII; else returns true 
	/// 
	/// @author Aayush Karki
	/// 
	/// @date  December 03, 2021
	///
	inline bool GetNoError() { return m_noError; }
...
private:
	...
	///					
	/// @note for DC is used to declare a value, it uses whole 12 digits of a word so the a_lengthToFill is 12
